...
# ==============================================================================
        if self.state == S_LOGGEDIN:
            ...
            if len(peer_msg) > 0:
                # Handle peer_msg whether it arrives as a string or already a dict
...
# ==============================================================================
            ...
            if len(peer_msg) > 0:    # peer's stuff, coming in
                ...
                if isinstance(peer_msg, dict):
                    if peer_msg["action"] == "exchange":
                        self.out_msg += peer_msg["from"] + ": " + peer_msg["message"]
                    elif peer_msg["action"] == "disconnect":
                        self.out_msg += peer_msg.get("msg", peer_msg.get("message", "Peer disconnected"))
                        self.state = S_LOGGEDIN

            # Display the menu again if we just disconnected
            if self.state == S_LOGGEDIN:
                self.out_msg += menu
# ==============================================================================
# invalid state
