...
# ==============================================================================
                ...
                from_name = self.logged_sock2name[from_sock]
                message = msg["message"]
                # Add message to the sender's index for future searching
                self.indices[from_name].add_msg_and_index(message)
                
                # Get the list of people in the same chat group
                the_guys = self.group.list_me(from_name)[1:] 
                for g in the_guys:
                    to_sock = self.logged_name2sock[g]
                    # Make sure you are using json.dumps here!
...
# ==============================================================================
                ...
                search_rslt = "\n".join([str(i) for i in search_rslt])
